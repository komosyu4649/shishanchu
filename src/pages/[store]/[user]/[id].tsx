...
export default function ContentDetail({
  ...
  return (
    <article className='mt-96 m-auto w-layoutMd'>
      <h1 className='text-xl text-center mb-28'>{contentsData.attributes.title}</h1>
      <div className='grid grid-cols-[1fr_34rem] justify-between gap-16'>
        ...
        <div className='p-20 rounded-3xl border-2 border-white border-opacity-60 border-solid bg-blackWeak'>
          ...
          <div
            className='prose prose-h2:px-8 prose-h2:py-6 prose-h2:rounded-3xl prose-h2:border-2 prose-h2:border-white prose-h2:border-opacity-60 prose-h2:border-solid prose-h2:bg-black prose-h2:text-white prose-h2:text-proseH2 prose-h3:text-proseH3 prose-h3:text-white prose-h3:border-b-2 prose-h3:border-white prose-h3:border-opacity-60 prose-h3:border-solid prose-h3:py-2 prose-h3:px-4 prose-h4:text-proseH4 prose-h4:text-white prose-h4:border-b-2 prose-h4:border-white prose-h4:border-opacity-60 prose-h4:border-solid prose-h4:py-2 prose-h4:px-4 prose-h5:text-proseH5 prose-h5:text-white prose-h5:border-b-2 prose-h5:border-white prose-h5:border-opacity-60 prose-h5:border-solid prose-h5:py-2 prose-h5:px-4 prose-h6:text-proseH6 prose-h6:text-white prose-h6:border-b-2 prose-h6:border-white prose-h6:border-opacity-60 prose-h6:border-solid prose-h6:py-2 prose-h6:px-4 prose-p:text-mdLhLgLt prose-li:text-mdLhLgLt prose-li:m-0 text-white max-w-none'
        ...
        <div className=''>
          ...
          <div className=''>
            ...
            {/* link */}
            <Link href={`/${store}/${user}`}>スタッフを見る</Link>
          </div>
          {/* tags */}
        </div>
      </div>
